...
// Temporarily disable direct contentlayer import (generation currently broken)
// import { allBlogs } from 'contentlayer/generated'

// Fallback empty list to keep build passing until contentlayer regenerates
const allBlogs: Array<any> = []
    ...
    <>
      ...
      <CommandDialog open={open} onOpenChange={setOpen}>
        ...
        <CommandList>
          ...
          {/* Blog search temporarily disabled pending contentlayer regeneration */}
          {/* <BlogCommandMenu
            runCommand={runCommand}
            messages={{
              blog: messages.blog,
