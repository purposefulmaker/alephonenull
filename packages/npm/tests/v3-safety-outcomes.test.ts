/**
 * ALEPHONENULL V3 — Comprehensive Safety Outcome Tests
 * 
 ...
 * detectors, but full end-to-end scan() calls through AlephOneNullV3.
 */

import { describe, it, expect, beforeEach } from 'vitest';
import { AlephOneNullV3 } from '../src/v3/engine';
import { ThreatLevel, Action, ScanResult } from '../src/v3/core/types';
...
describe('V3 Engine — Full Safety Outcomes', () => {

  beforeEach(() => {
    engine = new AlephOneNullV3({ behavior: { logToConsole: false, logDetections: false } });
  });
