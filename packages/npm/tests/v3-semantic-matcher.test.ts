/**
 * ALEPHONENULL V3 — Semantic Matcher Unit Tests
 * 
...
} from '../src/v3/core/semantic-matcher';
...
describe('fuzzyMatchPhrases', () => {
  ...
  it('should validate threshold bounds', () => {
    expect(() => fuzzyMatchPhrases('text', ['phrase'], -0.1)).toThrow(RangeError);
    expect(() => fuzzyMatchPhrases('text', ['phrase'], 1.1)).toThrow(RangeError);
  });

  it('should match a typo inside a longer sentence', () => {
    const results = fuzzyMatchPhrases(
