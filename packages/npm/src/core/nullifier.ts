...
export class NullSystem {
  ...
  emergencyIntervention(
    ...
    const safeText = this.generateEvaluationResponse(detectedPatterns);
    ...
    const result: InterventionResult = {
      ...
      metadata: {
        ...
        evaluationMode: this.isEvaluationMode,
  ...
  private generateEvaluationResponse(patterns?: DangerousPattern[]): string {
...
This message was generated by AlephOneNull safety systems.`;
  ...
  /**
   * Reset evaluation mode (use carefully)
   */
