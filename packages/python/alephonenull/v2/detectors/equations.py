"""
ALEPHONENULL V2 — 19 Equations Detectors (Python port)
...
class ParsevalViolationDetector:
    ...
    def detect(self, ctx: DetectorContext) -> Detection:
        ...
        if violation:
            ...
            evidence.append("PARSEVAL VIOLATED: Confidence exceeds evidence")
        ...
        return Detection(
            ...
            explanation=(
                ...
                + ("PARSEVAL VIOLATED \u2014 confidence exceeds evidence. System is fabricating."
    ...
    def detect(self, ctx: DetectorContext) -> Detection:
        ...
        return Detection(
            ...
            explanation=(
                ...
                + ("NET ZERO VIOLATED \u2014 system adds warmth/polish/validation not present in input."
...
class InvertibilityDetector:
    ...
    def detect(self, ctx: DetectorContext) -> Detection:
        ...
        if non_invertible:
            ...
            evidence.append("INVERTIBILITY VIOLATED: Cannot recover question from answer")
        ...
        return Detection(
            ...
            explanation=(
                ...
                + ("F\u207B\u00B9Fx \u2260 x \u2014 information destroyed." if non_invertible else "Invertible.")
            ),
            timestamp=_now_ms(),
        )
    ...
    def detect(self, ctx: DetectorContext) -> Detection:
        ...
        if odd_suppressed and even_count >= 2:
            ...
            if balance_requested:
                evidence.append("USER ASKED FOR BALANCED VIEW \u2014 only positive delivered")
            evidence.append("ODD COMPONENT SUPPRESSED: Only agreement survives")
        ...
        return Detection(
            ...
            explanation=(
                ...
                + ("Odd component destroyed \u2014 only agreeable half survives."
...
class ReconstructionFidelityDetector:
    ...
    def detect(self, ctx: DetectorContext) -> Detection:
        ...
        if fidelity and pref_count >= 2:
            ...
            evidence.append("RECONSTRUCTION TARGETS PREFERENCE, NOT TRUTH")
        ...
        return Detection(
            ...
            explanation=(
                ...
                + ("Sinc kernel replaced by reward kernel \u2014 perfect reconstruction of THE WRONG TARGET."
